...
Usage:
    $ python models/tf.py --weights ai.pt

Export:
    $ python path/to/export.py --weights ai.pt --include saved_model pb tflite tfjs
"""
...
def run(weights=ROOT / 'ai.pt',  # weights path
...
def parse_opt():
    ...
    parser.add_argument('--weights', type=str, default=ROOT / 'ai.pt', help='weights path')

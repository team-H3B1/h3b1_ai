...
Usage:
    $ python path/to/export.py --weights ai.pt --include torchscript onnx coreml openvino saved_model tflite tfjs

Inference:
    $ python path/to/detect.py --weights ai.pt
                                         yolov5s.torchscript
                                         yolov5s.onnx
...
def run(data=ROOT / 'data/coco128.yaml',  # 'dataset.yaml path'
        weights=ROOT / 'ai.pt',  # weights path
